...
const AdminSubjectScreen= () => {
  return (
    <View style={styles.container}>
      ...
      <View>
        <Text style={styles.StudentList_Text}>UPLOAD SUBJECT LIST</Text>
      ...
      <View>
        <View style={styles.Adding_Manually_View}>
          <Text style={styles.Adding_Manually_Text}>Adding Subject Manually</Text>
        </View>
        <View>
          ...
          <View style={styles.ManualMain_View}>
            <View style={styles.Manual_View}>
              <Text style={styles.Manual_Text}>Subject Name</Text>
          ...
          <View style={styles.ManualMain_View}>
            <View style={styles.Manual_View}>
              <Text style={styles.Manual_Text}> Duration</Text>
            </View>
            <View style={styles.TextInput_View}>
              <TextInput
                style={styles.Manual_TextInput}
