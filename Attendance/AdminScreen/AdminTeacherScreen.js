...
const AdminTeacherScreen= () => {
  return (
    <View style={styles.container}>
      ...
      <View>
        <Text style={styles.StudentList_Text}>UPLOAD TEACHER LIST</Text>
      ...
      <View>
        <View style={styles.Adding_Manually_View}>
          <Text style={styles.Adding_Manually_Text}>Adding Teacher Manually</Text>
        </View>
        <View>
          ...
          <View style={styles.ManualMain_View}>
            <View style={styles.Manual_View}>
              <Text style={styles.Manual_Text}>Skill</Text>
            </View>
            <View style={styles.TextInput_View}>
              <TextInput
                style={styles.Manual_TextInput}
                placeholder='Teacher Skill' />
            </View>
          </View>
